...
extension UIView{
    ...
    /**
     ...
     :param: pixelsLarger      amount to increase width and height by
     :param: animationDuration duration the whole animation should take
     :param: bottomMoves       deteremines if the bottom should stay in place while the view's size increases
     */
